# 2023 Aug 25: really not at all clear what I'm to do. Did my best. -ctf
...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/drh/Documents/GitHub/Maktaba-Project/Yikes/Sefaria-Mod/My-Databases/db1.sqlite', # Path to where you would like the database to be created including a file name, or path to an existing database file if using sqlite3.
...
DOMAIN_LANGUAGES = {
    "http://arabic.example.org": "arabic",
...
# TODO: For a deployment, you should register and use your own reCAPTCHA keys (https://pypi.org/project/django-recaptcha/#installation)
SILENCED_SYSTEM_CHECKS = ['captcha.recaptcha_test_key_error']

ALLOWED_HOSTS = ["localhost", "127.0.0.1","0.0.0.0"]

ADMINS = (
     ('Admin', 'carryingtheflame@protonmail.com'),
)
